...
export class ChatClient {
    ...
    processResponse(response){
        response = new Message(this.version, response);
	...
	console.log("Login decrypt data called")
    ...
    async _establishChatConnection(connectionAttempts = 7, reconnectionDelay = 8000){
	    ...
	    let connectString = "ws://" + this.url + ":" + this.port
	    console.log("About to call io. io is" + io)
	    console.log("IO keys are " + Object.keys(io))
	    console.log("Connection string is : " + connectString)
            self.chatSocket = io(connectString + '/chat', {
                reconnection: false,
                forceNew: true,
                autoConnect: false,
                connection: 'Upgrade',
